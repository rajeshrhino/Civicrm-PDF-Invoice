...
{elseif $action eq 4}
    ...
    {if $showInvoice eq 1}
        <a class="button" href="{crmURL p='civicrm/contact/view/contribution' q="reset=1&id=$id&cid=$contact_id&action=view_invoice&context=$context"}" accesskey='e'><span>View PDF Invoice</span></a>
    {else}
        <a class="button" href="#" onClick="alert('Invoice not yet generated by the cron job.Please view later.');return false;" accesskey="e">View Invoice</a>      
    {/if}
{else}
